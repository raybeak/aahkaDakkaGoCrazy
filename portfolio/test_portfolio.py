...
def run_tests():
    ...
    # 2. Test Owner Editable Feature (F-2)
    assert 'id="owner-toggle-btn"' in html, "Owner toggle button missing"
    assert 'id="owner-edit-panel"' in html, "Owner edit panel missing"
    assert 'id="owner-textarea"' in html, "Owner textarea missing"
    print("✓ F-2 Owner Editable Feature components verified.")
    ...
    assert 'id="glitch-toggle-btn"' in html, "Glitch mode toggle button missing"
